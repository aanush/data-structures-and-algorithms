package com.student.practice.done.practiceDP.typeX;
...
public class DecodeWaysOneCipherOneValue {

    public static void main(String[] args) {
        DecodeWaysOneCipherOneValue app = new DecodeWaysOneCipherOneValue();
        ...
        allCipher.add("25");
        allCipher.add("26");
        int ways = app.getDecodeWaysCount("12120", allCipher);
    ...
    private int getCipherWays(int w, int x, String info, SortedSet<String> sortedAllCipher) {
        // count of ways the cipher could assume is 1 if allCipher contains it, else 0
        return sortedAllCipher.contains(getCipher(info, w, x)) ? 1 : 0;
    }
